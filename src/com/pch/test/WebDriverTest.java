...
public class WebDriverTest {
	...
	public void funWithPayPalSignUpPage() {
		...
		WebElement we = driver.findElement(By.id("left-hero"));
		action.moveToElement(we).build().perform();
		
		//driver.findElement(By.id("left-hero")).click();
		...
		// Step 4: Enter password testtest1234 
	 	driver.findElement(By.id("paypalAccountData_password")).sendKeys("test1test");
        
		// Step 5: Enter confirm password testtest1234
	 	driver.findElement(By.id("paypalAccountData_confirmPassword")).sendKeys("test1test");
		 ...
		 * Assert True that error message contains the expectedErrorStr defined below
 		...
 		assert(actualErrorStr).contains(expectedErrorStr);
		 	
		// Step 8. Print out the boolean state of the 'confirmPassword' input field displayed
		WebElement expectedCheckbox = driver.findElement(By.xpath("//*[@id='PageMainForm']/div[2]/div[5]/div/div/span[1]"));
		boolean expectedCheckedStatus = expectedCheckbox.isSelected();
		System.out.println("Boolean state of checkbox : "+ expectedCheckedStatus);
		...
		assert(driver.findElement(By.xpath("//*[@id='PageMainForm']/div[5]/span[1]/a"))).isDisplayed();
	}
